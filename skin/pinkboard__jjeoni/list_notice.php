...
<tr align=center bgcolor=FFDDEE>
  <td nowrap><font color=FF8CB0  style=font-family:matchworks,tahoma;font-size:7pt>NOTICE</td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data['no']?>"></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;'>&nbsp; <?=$insert?><?=$subject?> <font style=font-family:matchworks;font-size:8pt><?=$comment_num?></font></td> 
  <td nowrap><?=$face_image?>&nbsp;&nbsp;<?=$name?>&nbsp;&nbsp;</div></td>
  <td nowrap><font color=FF8CB0 style=font-family:matchworks,tahoma;font-size:7pt>&nbsp;<?=$reg_date?>&nbsp;</td>
  <td nowrap><font color=FF8CB0 style=font-family:matchworks,tahoma;font-size:7pt><?=$hit?></td>
</tr>
<tr><td height=1 colspan=6 background=<?=$dir?>/dot.gif><img src=<?=$dir?>/dot.gif border=0 height=1></td></tr>
