...
$subject = str_replace(">","><font class=t_notice>",$subject);
...
?>
	<tr align=center class=noticeline onmouseover="this.style.backgroundColor='#000000'" onmouseout="this.style.backgroundColor=''">
	<td></td>
	<td class=t_notice>!</td>
	<td align=left nowrap class=t_notice colspan=4>
